...
public class Player implements Comparable<Player>, Serializable {
  ...
  public int compareTo(Player other) {
    ...
    int lNameInt = lastName.compareTo(other.getLastName());
    if(lNameInt == 0){
  ...
  public String printPlayer(){
    String stats = "";
    String size = Integer.toString(heightInInches);
    String hasExp = " Experienced.";
    String noExp = " Inexperienced.";
    if (previousExperience == true){
      stats = lastName+","+firstName+" Height: "+size+"\""+hasExp;
    }else{
      stats = lastName+","+firstName+" Height: "+size+"\""+noExp;
    }
    return stats;
  }
